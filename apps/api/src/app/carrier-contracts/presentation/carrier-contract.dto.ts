...
const CYCLES: CarrierPaymentCycle[] = [
  'monthly',
  'quarterly',
  'semi_annual',
  'annual',
...
export class ListCarrierContractsQueryDto {
  ...
  @MaxLength(80)
  carrier?: string;
  @ApiPropertyOptional({ enum: SERVICES })
  @IsOptional()
  @IsEnum(SERVICES)
...
export class CreateCarrierContractDto {
  ...
  @Min(0)
  unitPrice?: number;
  @ApiPropertyOptional({ enum: CYCLES })
  @IsOptional()
  @IsEnum(CYCLES)
...
export class UpdateCarrierContractDto {
  ...
  @ApiPropertyOptional({ enum: CYCLES, nullable: true })
  @IsOptional()
  @IsEnum(CYCLES)
...
export class CarrierContractIdParamDto {
  @ApiProperty() @IsMongoId() contractId!: string;
}
